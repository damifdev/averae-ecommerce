  ...
  return <div className="min-h-screen bg-[#F6F0E6] text-[#382820]"><SiteHeader /><main>
    ...
    <section className="container grid gap-12 py-14 md:py-20 lg:grid-cols-[.78fr_1.22fr]">
      <aside className="space-y-10">
        ...
        <div className="border border-[#D7C2A7] bg-[#FFFDF8]/55 p-5"><p className="font-display text-2xl">Looking for a quick answer?</p><p className="mt-2 text-sm leading-6 text-[#866F62]">Browse our most common delivery, returns, and order questions.</p><div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-3"><Link href="/faq" onClick={() => trackEngagement('contact_faq_click', { source: 'contact' })} className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[.14em] underline underline-offset-4">VIEW FAQs <ArrowRight size={14} /></Link><Link href="/delivery" className="text-[10px] uppercase tracking-[.14em] underline underline-offset-4">DELIVERY INFORMATION</Link><Link href="/returns" className="text-[10px] uppercase tracking-[.14em] underline underline-offset-4">RETURNS POLICY</Link></div></div>
