...
export const lookCollections = [
  ...
  { slug: 'unisex-look', audience: 'Unisex' as const, title: 'Open expression', description: 'A considered mix of texture, proportion and useful objects.', image: '/manus-storage/averae-product-bag_c6fe5185.jpg', productIds: [1, 2, 7], hotspots: [{ productId: 1, x: 34, y: 34, label: 'Linen Shirt' }, { productId: 2, x: 57, y: 57, label: 'Leather Crossbody Bag' }, { productId: 7, x: 76, y: 72, label: 'Sculptural Earrings' }] },
] as const;
