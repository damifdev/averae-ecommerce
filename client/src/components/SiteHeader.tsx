...
import { cartItemCount, CART_UPDATED_EVENT, clearCart, getCart, getLastAddedCartItem, getWishlist, removeFromCart, type CartItem } from '@/lib/store';
...
export default function SiteHeader() {
  ...
  const removeBagLine = (item: CartItem) => setCartItems(removeFromCart(item.id, item.size, item.color));
  const clearBag = () => setCartItems(clearCart());
